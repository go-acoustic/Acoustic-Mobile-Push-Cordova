...
echo ""
cordova plugin add file:../../../plugins/co.acoustic.mobile.push.sdk --variable CUSTOM_ACTIONS="openInboxMessage sendEmail" --variable ANDROID_APPKEY="YOUR ANDROID APPKEY HERE" --variable IOS_DEV_APPKEY="YOUR iOS APPKEY HERE" --variable IOS_PROD_APPKEY="YOUR iOS APPKEY HERE" --variable SERVER_URL=https://mobile-sdk-lib-xx-y.brilliantcollector.com --variable LOGLEVEL=error --variable MCE_CAN_SYNC_OVERRIDE=true --force
...
echo ""
cordova plugin add file:../../../plugins/co.acoustic.mobile.push.plugin.calendar
...
echo ""
cordova plugin add file:../../../plugins/co.acoustic.mobile.push.plugin.action-menu

echo "Adding iOS Passbook"
echo ""
cordova plugin add file:../../../plugins/co.acoustic.mobile.push.plugin.passbook
