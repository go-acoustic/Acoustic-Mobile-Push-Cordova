 ...
 public class MceJsonApi {
    ...
    private static final String TAG = "MceJsonApi";
     ...
     public interface Methods {
         ...
         interface AddInAppMessage {
             String NAME = "addInAppMessage";
             int MESSAGE_INDEX = 0;
         }
 
         interface SyncInAppMessages {
             String NAME = "syncInAppMessages";
         }
 
         interface ExecuteInAppRule {
             String NAME = "executeInAppRule";
             int RULES_INDEX = 0;
         }
 
         interface DeleteInAppMessage {
             String NAME = "deleteInAppMessage";
             int MESSAGE_ID_INDEX = 0;
         }
 
         interface RegisterInAppTemplate {
             String NAME = "registerInAppTemplate";
             int TEMPLATE_NAME_INDEX = 0;
             int STATE_INDEX = 1;
         }
 
         interface ExecuteInAppAction {
             String NAME = "executeInAppAction";
             int ACTION_INDEX = 0;
         }
         ...
         interface SendMessageOpenedEvent {
             String NAME = "sendMessageOpenedEvent";
         }
     }
 }
