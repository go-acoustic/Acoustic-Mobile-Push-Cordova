 ...
 public class MceJsonApi {
    ...
    private static final String TAG = "MceJsonApi";
     ...
     public static void beaconRegions(Context context, JsonCallback callback) throws JSONException {
         ...
         List<LocationApi> trackedIBeacons = new LinkedList<>();
         try {
     ...
     public interface Methods {
         interface BeaconRegions {
             String NAME = "beaconRegions";
         }
         interface SetBeaconEnterCallback {
             String NAME = "setBeaconEnterCallback";
             int STATE_INDEX = 0;
         }
         interface SetBeaconExitCallback {
             String NAME = "setBeaconExitCallback";
             int STATE_INDEX = 0;
         }
         interface BeaconEnabled {
             String NAME = "beaconEnabled";
         }
 
         interface BeaconUUID {
             String NAME = "beaconUUID";
         }
     }
